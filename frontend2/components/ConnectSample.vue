...
export default Vue.extend({
  ...
  data() {
    return {
      availableConnectTypes: [] as Array<ConnectType>,
      availableInstallTypes: [] as Array<ConnectType>,
      availableConnections: [] as Array<Connection>,
      states: {} as WalletStates,
      supportFeatures: [] as Array<string>,
      connected: false,
