module.exports = ({ wallets, refs, config, client }) => ({
  ...
  gen0Mint: (owner, payment = undefined, signer = wallets.owner) => {
    const coin = {};
    coin[payment.denom] = payment.amount + Math.trunc(payment.amount/1000);
    return client.execute(signer, "gen0", { mint: { owner, payment: {denom: payment.denom, amount: payment.amount.toString()} } }, coin)
  },
...
// await lib.gen0Mint("terra1x46rqay4d3cssq8gxxvqz8xt6nwlz4td20k38v")
// await lib.gen0Mint("terra1x46rqay4d3cssq8gxxvqz8xt6nwlz4td20k38v", {denom:"uusd", amount:100000})